package com.github.joelgodofwar.vwh.common.error;
...
import com.github.joelgodofwar.vwh.VillagerWorkstationHighlights;
import com.github.joelgodofwar.vwh.common.collections.ExpireHashMap;
import com.github.joelgodofwar.vwh.common.error.Report.ReportBuilder;
import com.github.joelgodofwar.vwh.common.reflect.PrettyPrinter;
import com.github.joelgodofwar.vwh.util.StrUtils;
...
public class DetailedErrorReporter implements ErrorReporter {
	...
	public static final String DEFAULT_SUPPORT_URL = "https://discord.gg/Fq9HQ2dmtd";
	...
	private VillagerWorkstationHighlights vwh;
	...
	public DetailedErrorReporter(Plugin plugin, String prefix, String supportURL, int maxErrorCount, Logger logger) {
		...
		this.logger = logger;
		this.vwh = (VillagerWorkstationHighlights) plugin;
	}
	...
	public boolean reportMinimalNoSpam(Plugin sender, String methodName, Throwable error) {
		String pluginName = sender.getName();
	...
	public void reportDetailed(Object sender, Report report) {
		...
		writer.println("Copy from above line down to ↓↓↓");
		writer.println("If this problem hasn't already been reported, please post");
		writer.println("at " + supportURL + " with the following data:");

		// Data dump!
		writer.println("Data Dump:");
		...
		// And plugin
		if (plugin != null) {
			writer.println("Version: " + vwh.getName() + " v" + vwh.getDescription().getVersion());
			String jarfilename = vwh.getjarfilename();
		...
		FileConfiguration config = vwh.getConfig();
	...
	private String getPluginList() {
		...
		return "Plugins (" + plugins.length + "): " + pluginList.toString() + ChatColor.RESET;
	}
