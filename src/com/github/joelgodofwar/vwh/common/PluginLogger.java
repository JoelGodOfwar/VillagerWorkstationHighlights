...
/**
 * Custom logger for the VillagerWorkstationHighlights plugin.
 */
...
public class PluginLogger {
	 ...
	 * @param plugin The VillagerWorkstationHighlights plugin instance.
	 */
	public PluginLogger(VillagerWorkstationHighlights plugin) {
	...
	public void log(Level level, String message, Object... args) {
		String pluginName = ChatColor.RESET + "[" + ChatColor.YELLOW + vwh.getName() + ChatColor.RESET + "] ";
